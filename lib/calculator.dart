        ...
        children: <Widget>[
          Expanded(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: <Widget>[
                _buildKeyboardButton('AC', textColor: Colors.amberAccent),
                _buildKeyboardButton('DEL', textColor: Colors.amberAccent),
                _buildKeyboardButton('%', textColor: Colors.amberAccent),
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _buildKeyboardButton('=', textColor: Colors.lightBlueAccent),
              ],
            ),
          ),
        ],
